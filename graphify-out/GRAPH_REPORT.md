...
## Corpus Check
- 534 files · ~215,461 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4597 nodes · 5206 edges · 619 communities (444 shown, 175 thin omitted)
- Extraction: 94% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97451f26`
...
1. `[1.2.0] — 2026-06-03` - 62 edges
2. `[1.5.0] — 2026-07-13` - 46 edges
3. `Toast` - 43 edges
4. `Column` - 42 edges
5. `[1.3.0] — 2026-06-04` - 34 edges
6. `Column Class (DataTable domain model)` - 34 edges
7. `[1.4.0] — 2026-07-13` - 33 edges
8. `[0.1.0] — 2026-03-18` - 33 edges
9. `Column` - 33 edges
...
## Communities (619 total, 175 thin omitted)
...
Cohesion: 0.05
Nodes (61): BladeIconsServiceProvider (vendor), BladeLucideIconsServiceProvider (vendor), BreadcrumbManager Class (stub, referenced), BreadcrumbManagerTest, BreadcrumbTrail, ComponentResolver, Confirm-callback forgery-resistant authorization, Confirm (+53 more)
...
Cohesion: 0.04
Nodes (54): [1.5.0] — 2026-07-13, Added, Added, Added, Added, Added, Added, Added (+46 more)

### Community 5 - "Upload (JS)"
Cohesion: 0.04
Nodes (54): [1.2.0] — 2026-06-03, Accessibility, Added, Added, Added, Added, Added, Added (+46 more)
...
Cohesion: 0.18
Nodes (40): [0.1.0] — 2026-03-18, Added, Added, Added, Added, Added, Added, Added (+32 more)
...
Cohesion: 0.06
Nodes (33): [1.3.0] — 2026-06-04, Added, Added, Added, Added, Added, Added, Added (+25 more)
...
Cohesion: 0.15
Nodes (25): BooleanColumn, Column, ColumnPinningTest, ColumnTest, FilterPreset, FilterPresetsTest, HasAggregation, HasEditing (+17 more)
...
Cohesion: 0.14
Nodes (23): Breadcrumbs Index Component, Breadcrumbs Item Partial, Breadcrumbs Separator Partial, KoreColorPicker Alpine Component, KoreDatePicker Alpine Component, Dropdown Alpine Component, startFloating, stopFloating (+15 more)
...
Cohesion: 0.22
Nodes (21): [1.4.1] — 2026-07-13, code:php ($paso = TimeTicks::interval($desde, $hasta, count: 8);   // ), code:js (if (!target) target = objects[objects.length - 1];   // el x), code:css ([wire\:loading], [wire\:loading\.delay], [wire\:loading\.fle), code:diff (- <div wire:loading.delay.flex class="absolute inset-0 …">), Fixed, Fixed, Fixed (+13 more)
...
Cohesion: 0.12
Nodes (16): [1.0.0] — 2026-04-03, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed (+8 more)
...
Cohesion: 0.25
Nodes (16): BooleanFilter, DateFilter, DateRangeFilter, EventsTest, Filter, FilterApplied, FilteringTest, FilterTest (+8 more)
...
Cohesion: 0.14
Nodes (4): TestAggregationTable, TestDeferredTable, TestEditableTable, KoreDataTable Alpine Component
...
Cohesion: 0.24
Nodes (10): BulkAction, BulkActionExecuted, BulkActionTest, CsvExporter, Base Filtered Query Pattern, Exporter (interface), WithBulkActions, WithExport (+2 more)
...
Cohesion: 0.28
Nodes (9): exportMaxRows Enforcement Over chunk(), kore_toast(), Preset Count Caching & Invalidation, Select-All-Matching Operates on Filtered Query, SelectionTest, Server-Side Cross-Page Selection State (Option C), Sprint2Test, Stale .checked Morph Bug Regression Guard (+1 more)
...
Cohesion: 0.29
Nodes (6): kore::chart.donut, kore::chart.gauge, kore::chart.legend, kore::chart.table, kore::chart.tooltip, kore::chart.zoom
...
## Knowledge Gaps
- **1409 isolated node(s):** `medias`, `panels`, `gutterEls`, `startSizes`, `instances` (+1404 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `Filter Contract` to `WithResponsive.php`, `index.blade.php`, `index.blade.php`, `item.blade.php`, `index.blade.php`, `Time Picker (JS)`, `kore-ui.php`, `DataTable Test Fixtures`, `date.blade.php`, `text.blade.php`, `boolean.blade.php`, `WithBulkActions.php`?**
