# Graph Report - kore-ui  (2026-07-15)

## Corpus Check
- 589 files · ~236,301 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4898 nodes · 5560 edges · 672 communities (495 shown, 177 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 288 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e043e793`
...
1. `[1.2.0] — 2026-06-03` - 74 edges
2. `[1.5.0] — 2026-07-13` - 55 edges
3. `Toast` - 43 edges
4. `Column` - 42 edges
5. `[1.3.0] — 2026-06-04` - 40 edges
6. `[1.4.0] — 2026-07-13` - 39 edges
7. `[0.1.0] — 2026-03-18` - 39 edges
8. `Plot` - 36 edges
9. `Column Class (DataTable domain model)` - 34 edges
10. `Column` - 33 edges
...
## Communities (672 total, 177 thin omitted)

### Community 0 - "Datepicker (JS)"
Cohesion: 0.03
Nodes (63): [1.2.0] — 2026-06-03, Accessibility, Added, Added, Added, Added, Added, Added (+55 more)
...
Cohesion: 0.03
Nodes (62): [1.5.0] — 2026-07-13, Added, Added, Added, Added, Added, Added, Added (+54 more)
...
Cohesion: 0.07
Nodes (33): _addClickAwayListener(), _addDays(), _buildMonthGrid(), _buildWeeks(), calendars(), _checkResponsive(), _cleanup(), _daysInMonth() (+25 more)
...
Cohesion: 0.17
Nodes (46): [0.1.0] — 2026-03-18, Added, Added, Added, Added, Added, Added, Added (+38 more)
...
Cohesion: 0.05
Nodes (38): [1.3.0] — 2026-06-04, Added, Added, Added, Added, Added, Added, Added (+30 more)

### Community 13 - "DataTable Interactions (JS)"
Cohesion: 0.05
Nodes (37): [1.4.0] — 2026-07-13, Added, Added, Added, Added, Added, Added, Added (+29 more)
...
Cohesion: 0.17
Nodes (23): applyHelper(), applyPreset(), _applyTimeTo(), buildCalendar(), cancel(), clear(), close(), confirm() (+15 more)
...
Cohesion: 0.23
Nodes (22): [1.4.1] — 2026-07-13, code:js (if (!target) target = objects[objects.length - 1];   // el x), code:css ([wire\:loading], [wire\:loading\.delay], [wire\:loading\.fle), code:diff (- <div wire:loading.delay.flex class="absolute inset-0 …">), Fixed, Fixed, Fixed, Fixed (+14 more)
...
Cohesion: 0.11
Nodes (6): columns(), query(), TestBulkTable, TestEditableTable, TestSearchTable, TestUser
...
Cohesion: 0.11
Nodes (19): [1.0.0] — 2026-04-03, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed (+11 more)
...
Cohesion: 0.18
Nodes (19): ColumnPinningTest, CsvExporter, Base Filtered Query Pattern, Exporter (interface), FilterPreset, FilterPresetsTest, KoreDataTable, TestDefaultPresetTable (+11 more)
...
Cohesion: 0.12
Nodes (17): [1.1.0] — 2026-04-04, Added, Added, Added, Added, Added, Added, Added (+9 more)
...
Cohesion: 0.13
Nodes (16): BreadcrumbManager singleton, <x-kore::breadcrumbs> component, JSON-LD structured data output, Overlay System (v0.1.0), Theming System (v0.1.0), 20+ UI Components (v0.1.0), v0.1.0 Release (initial pre-release), ActionColumn (+8 more)
...
Cohesion: 0.27
Nodes (10): [1.6.0] — 2026-07-14, [1.7.0] — 2026-07-15, Added, Added, Changed, Changelog, code:php ($paso = TimeTicks::interval($desde, $hasta, count: 8);   // ), Detalles que quizá quieras conocer (+2 more)
...
Cohesion: 0.2
Nodes (11): BulkAction, BulkActionExecuted, BulkActionTest, EventsTest, FilterApplied, RowUpdated, SelectionTest, Server-Side Cross-Page Selection State (Option C) (+3 more)
...
## Knowledge Gaps
- **1517 isolated node(s):** `medias`, `panels`, `gutterEls`, `startSizes`, `instances` (+1512 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `Column Pinning & Presets Tests` to `link.blade.php`, `color.blade.php`, `WithExport.php`, `Pest.php`, `ThemeSwitchTest.php`, `Row Actions`, `Form Field Accessibility`, `empty-state.blade.php`, `NumberRangeFilter`, `date.blade.php`?**
