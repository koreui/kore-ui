...
## Corpus Check
- 498 files · ~171,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4130 nodes · 4535 edges · 582 communities (420 shown, 162 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 265 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d2f9e1d`
...
- `Accordion Item Component` --semantically_similar_to--> `Card Component`  [INFERRED] [semantically similar]
  kore-ui/resources/views/components/accordion/item.blade.php → kore-ui/docs/ui/card.md
...
## Communities (582 total, 162 thin omitted)
...
Cohesion: 0.14
Nodes (16): calls, cleanup, handle, plot, point, rect, close(), destroy() (+8 more)
...
Cohesion: 0.11
Nodes (6): columns(), query(), TestAggregationTable, TestBulkTable, TestScopedEditableTable, TestUser
...
Cohesion: 0.11
Nodes (5): TestDefaultPresetTable, TestDeferredTable, TestEditableTable, TestTable, KoreDataTable Alpine Component
...
Cohesion: 0.14
Nodes (16): [1.5.0] — 2026-07-13, [1.6.0] — 2026-07-14, Added, Added, Added, Changed, Changed, Changed (+8 more)

### Community 68 - "SpotlightDependency"
Cohesion: 0.3
Nodes (16): [0.1.0] — 2026-03-18, Added, Added, Added, Added, Componentes de Formulario (18), Componentes UI (20+), Configuración (+8 more)
...
Cohesion: 0.19
Nodes (16): BulkActionExecuted, ColumnPinningTest, CsvExporter, Base Filtered Query Pattern, Exporter (interface), KoreDataTable, WithBulkActions, WithDeferredLoading (+8 more)
...
Cohesion: 0.15
Nodes (13): [1.2.0] — 2026-06-03, Accessibility, Added, Added, Added, Changed, Changed, Changed (+5 more)
...
Cohesion: 0.2
Nodes (9): [1.0.0] — 2026-04-03, [1.1.0] — 2026-04-04, Added, Added, Added, Changelog, Fixed, Fixed (+1 more)
...
Cohesion: 0.22
Nodes (9): [1.4.0] — 2026-07-13, Added, Added, Added, Chore, Deprecated, Fixed, Fixed (+1 more)
...
Cohesion: 0.25
Nodes (8): [1.3.0] — 2026-06-04, Added, Added, Added, Fixed, Fixed, Fixed, Security
...
Cohesion: 0.29
Nodes (8): Column, ColumnTest, HasAggregation, HasSearch, HasSorting, HasVisibility, WithColumnSelect, WithResponsive

### Community 210 - "table.blade.php"
Cohesion: 0.32
Nodes (8): BooleanColumn, EventsTest, FilterApplied, HasEditing, InlineEditingTest, RowUpdated, TestEditableTable, WithFiltering
...
Cohesion: 0.43
Nodes (7): [1.4.1] — 2026-07-13, code:js (if (!target) target = objects[objects.length - 1];   // el x), code:css ([wire\:loading], [wire\:loading\.delay], [wire\:loading\.fle), code:diff (- <div wire:loading.delay.flex class="absolute inset-0 …">), Fixed, Fixed, Fixed
...
## Knowledge Gaps
- **1191 isolated node(s):** `medias`, `panels`, `gutterEls`, `startSizes`, `instances` (+1186 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `DataTable Interactions (JS)` to `Kore ThemeSwitch Component`, `Overlay Runtime (Alpine)`, `HasOverlayBehavior.php`, `header.blade.php`, `HasAggregation.php`, `WithPagination.php`, `WithInlineEditing.php`, `index.blade.php`, `header.blade.php`?**
