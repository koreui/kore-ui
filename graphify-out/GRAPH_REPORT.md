...
## Corpus Check
- 496 files · ~168,872 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4094 nodes · 4489 edges · 590 communities (426 shown, 164 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 265 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `edc96039`
...
## Communities (590 total, 164 thin omitted)
...
Cohesion: 0.11
Nodes (5): TestAggregationTable, TestExportTable, TestSearchTable, TestTable, KoreDataTable Alpine Component
...
Cohesion: 0.14
Nodes (18): ActionColumn, BadgeColumn, ColorColumn, ColorColumnSecurityTest, ColumnInteractionTest, ColumnTypesTest, ComponentColumn, DateColumn (+10 more)
...
Cohesion: 0.3
Nodes (14): [0.1.0] — 2026-03-18, Added, Added, Added, Componentes de Formulario (18), Componentes UI (20+), Configuración, Fixed (+6 more)
...
Cohesion: 0.22
Nodes (14): CSV/Formula Injection Mitigation, exportMaxRows Enforcement Over chunk(), FilterPreset, FilterPresetsTest, IDOR Protection via Query Scoping, LIKE Wildcard Literal Escaping, Preset Count Caching & Invalidation, SecurityHardeningTest (+6 more)
...
Cohesion: 0.19
Nodes (13): Alpine Plugin Registration Entry Point, KoreMaskable Alpine Component, KoreNumber Alpine Component, Range Slider Component, KoreRange Alpine Component, Rating Component, KoreRating Alpine Component, Array Field Sync via $wire.$set (+5 more)
...
Cohesion: 0.2
Nodes (12): [1.5.0] — 2026-07-13, [1.6.0] — 2026-07-14, Added, Added, Changed, Changed, Detalles que quizá quieras conocer, Detalles que quizá quieras conocer (+4 more)
...
Cohesion: 0.22
Nodes (9): [1.2.0] — 2026-06-03, Accessibility, Added, Added, Changed, Changed, Fixed, Security (+1 more)
...
Cohesion: 0.22
Nodes (9): Chip Component, ChipTest Suite, Icon Component, IconTest Suite, kore-ui.php Config File, Skeleton Component, SkeletonTest Suite, Timeline (+1 more)
...
Cohesion: 0.25
Nodes (7): [1.0.0] — 2026-04-03, [1.1.0] — 2026-04-04, Added, Added, Changelog, Fixed, Fixed
...
Cohesion: 0.25
Nodes (7): Chart Area, code:blade (<x-kore::chart :data="$ventas" x="mes">), code:blade (<x-kore::chart.area y="ingresos" curve="monotone" />), Los huecos, Por qué el área sí llega al cero, Props, Uso básico
...
Cohesion: 0.29
Nodes (7): [1.4.0] — 2026-07-13, Added, Added, Chore, Deprecated, Fixed, Fixed
...
Cohesion: 0.29
Nodes (6): Chart Donut, code:blade (<x-kore::chart :data="$ventas" x="mes" title="Reparto">), Detalles que importan, Limitaciones, Props, Uso básico
...
Cohesion: 0.33
Nodes (7): BulkAction, BulkActionTest, Select-All-Matching Operates on Filtered Query, SelectionTest, Server-Side Cross-Page Selection State (Option C), Stale .checked Morph Bug Regression Guard, TestBulkTable
...
Cohesion: 0.33
Nodes (6): [1.3.0] — 2026-06-04, Added, Added, Fixed, Fixed, Security
...
Cohesion: 0.4
Nodes (3): { chart }, { chart, nodes }, PAYLOAD

### Community 261 - "index.blade.php"
Cohesion: 0.6
Nodes (5): [1.4.1] — 2026-07-13, code:css ([wire\:loading], [wire\:loading\.delay], [wire\:loading\.fle), code:diff (- <div wire:loading.delay.flex class="absolute inset-0 …">), Fixed, Fixed
...
Cohesion: 0.5
Nodes (4): Page Loading Component, Feedback Manager, Overlay Manager, PageLoadingTest Suite
...
## Knowledge Gaps
- **1172 isolated node(s):** `medias`, `panels`, `gutterEls`, `startSizes`, `instances` (+1167 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `DataTable Interactions (JS)` to `kore::color-picker component`, `SpotlightDefaults`, `DataTable Core Model`, `index.blade.php`, `item.blade.php`, `TestBulkTable`, `Alpine Plugin Registry`, `HasEditing.php`, `item.blade.php`, `separator.blade.php`, `index.blade.php`?**
