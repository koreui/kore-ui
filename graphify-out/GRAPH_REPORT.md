# Graph Report - kore-ui  (2026-08-19)

## Corpus Check
- 616 files · ~255,889 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5209 nodes · 6042 edges · 682 communities (505 shown, 177 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 307 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7604a66e`
...
1. `[1.2.0] — 2026-06-03` - 94 edges
2. `[1.5.0] — 2026-07-13` - 67 edges
3. `[1.3.0] — 2026-06-04` - 51 edges
4. `[1.4.0] — 2026-07-13` - 47 edges
5. `[0.1.0] — 2026-03-18` - 47 edges
6. `Column` - 46 edges
7. `Column Class (DataTable domain model)` - 44 edges
8. `Toast` - 43 edges
9. `Plot` - 36 edges
10. `Column` - 33 edges
...
## Communities (682 total, 177 thin omitted)

### Community 0 - "Datepicker (JS)"
Cohesion: 0.03
Nodes (77): [1.5.0] — 2026-07-13, Added, Added, Added, Added, Added, Added, Added (+69 more)

### Community 1 - "Overlay Resolution & Defaults"
Cohesion: 0.03
Nodes (77): [1.2.0] — 2026-06-03, Accessibility, Accessibility, Accessibility, Accessibility, Added, Added, Added (+69 more)

### Community 2 - "Getting Started & Docs Hub"
Cohesion: 0.08
Nodes (74): [0.1.0] — 2026-03-18, [1.1.0] — 2026-04-04, Added, Added, Added, Added, Added, Added (+66 more)
...
Cohesion: 0.04
Nodes (46): [1.4.0] — 2026-07-13, Added, Added, Added, Added, Added, Added, Added (+38 more)
...
Cohesion: 0.05
Nodes (43): [1.3.0] — 2026-06-04, Added, Added, Added, Added, Added, Added, Added (+35 more)
...
Cohesion: 0.08
Nodes (23): Action Class (row action item), BulkAction Class, Column Class (DataTable domain model), DataTable Bulk Actions Partial, DataTable Action Column Renderer, DataTable Badge Column Renderer, DataTable Boolean Column Renderer, DataTable Color Column Renderer (+15 more)
...
Cohesion: 0.05
Nodes (4): Column, columns(), query(), TestDeferredTable
...
Cohesion: 0.06
Nodes (18): checkBreakpoint(), ensurePinnedMorphHook(), init(), a, b, cell, foreign, input (+10 more)
...
Cohesion: 0.08
Nodes (6): TestAggregationTable, TestBulkTable, TestPresetsTable, TestRelationExportTable, TestTable, TestUser

### Community 29 - "JS Entry & Plugins Index"
Cohesion: 0.09
Nodes (24): BreadcrumbManager Class (stub, referenced), BreadcrumbManagerTest, Breadcrumbs Index Component, Breadcrumbs Item Partial, Breadcrumbs Separator Partial, BreadcrumbTrail, Confirm-callback forgery-resistant authorization, Confirm (+16 more)

### Community 30 - "Splitter (JS)"
Cohesion: 0.13
Nodes (27): [1.6.0] — 2026-07-14, Accessibility, Added, Added, Added, Added, Added, Added (+19 more)
...
Cohesion: 0.2
Nodes (26): [1.4.1] — 2026-07-13, code:js (if (!target) target = objects[objects.length - 1];   // el x), code:css ([wire\:loading], [wire\:loading\.delay], [wire\:loading\.fle), code:diff (- <div wire:loading.delay.flex class="absolute inset-0 …">), Fixed, Fixed, Fixed, Fixed (+18 more)
...
Cohesion: 0.11
Nodes (26): BladeIconsServiceProvider (vendor), BladeLucideIconsServiceProvider (vendor), ComponentResolver, ConfirmDialog, ConfirmDialogTest test suite, CustomOverlay Fixture, DemoOverlay Fixture, DemoSpotlightComponent Fixture (+18 more)
...
Cohesion: 0.08
Nodes (23): Alpine.js Plugin, Atajo de teclado, code:php (Column::make('Empresa', 'company.name'),      // with('compa), code:php (// Siempre oculta), code:php (Column::make('Estado', 'status')), code:php (<?php), code:blade ({{-- resources/views/products/index.blade.php --}}), code:php (Column::make('Nombre', 'name')) (+15 more)
...
Cohesion: 0.09
Nodes (23): [1.0.0] — 2026-04-03, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed (+15 more)
...
Cohesion: 0.14
Nodes (22): ActionColumn, BulkActionExecuted, ColumnPinningTest, CsvExporter, Base Filtered Query Pattern, EventsTest, Exporter (interface), FilterApplied (+14 more)
...
Cohesion: 0.13
Nodes (19): BulkAction API, code:php (// Se esconde Y se protege. Lo segundo es lo que cuenta.), code:php (public function archivar(array $ids): void), code:php (public function notificar(array $ids): void), code:php (public function configure(): void), code:php (use KoreUi\DataTable\Views\Contracts\SavedViewStore;), code:php (// AppServiceProvider::register()), code:php (public function configure(): void) (+11 more)
...
Cohesion: 0.12
Nodes (4): getValue, trap, _formatNumber(), init()
...
Cohesion: 0.15
Nodes (12): [1.7.0] — 2026-07-15, [1.7.1] — 2026-08-18, Added, Changed, Changed, Changed, Changed, Changelog (+4 more)
...
Cohesion: 0.22
Nodes (10): Bulk Actions, code:php (// config/kore-ui.php), code:php (public function configure(): void), code:php (use KoreUi\DataTable\Actions\BulkAction;), code:php (public function activate(array $ids): void), Comportamiento, Configurar, Definir acciones (+2 more)
...
Cohesion: 0.28
Nodes (9): CSV/Formula Injection Mitigation, ExportTest, IDOR Protection via Query Scoping, LIKE Wildcard Literal Escaping, Security Audit Findings (C2/S3 checklist), SecurityHardeningTest, Sort Whitelist & Direction Normalization, TestExportTable (+1 more)
...
## Knowledge Gaps
- **1602 isolated node(s):** `medias`, `trap`, `getValue`, `panels`, `gutterEls` (+1597 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `Time Picker (JS)` to `SkeletonTest.php`, `Kore`, `CarouselTest.php`, `KbdTest.php`, `AccordionTest.php`, `Form Field Accessibility`, `PageLoadingTest.php`, `TabTest.php`, `DataTable Test Fixtures`, `Spotlight Items`, `Button`, `rating.js`, `Filters (Tests)`, `parent`, `StatsTest.php`?**
