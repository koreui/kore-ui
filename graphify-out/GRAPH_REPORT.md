...
## Corpus Check
- 498 files · ~176,478 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4212 nodes · 4664 edges · 588 communities (426 shown, 162 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 265 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3852e173`
...
6. `[1.2.0] — 2026-06-03` - 30 edges
7. `KoreDataTable` - 30 edges
8. `TestUser` - 30 edges
9. `FilterPreset` - 28 edges
...
## Communities (588 total, 162 thin omitted)
...
Cohesion: 0.07
Nodes (29): [1.2.0] — 2026-06-03, Accessibility, Added, Added, Added, Added, Added, Added (+21 more)
...
Cohesion: 0.09
Nodes (24): [1.5.0] — 2026-07-13, [1.6.0] — 2026-07-14, Added, Added, Added, Changed, Changed, Changed (+16 more)

### Community 27 - "Column Types & Inline Editing"
Cohesion: 0.26
Nodes (24): [0.1.0] — 2026-03-18, Added, Added, Added, Added, Added, Added, Added (+16 more)
...
Cohesion: 0.13
Nodes (21): ActionColumn, BulkAction, BulkActionTest, CSV/Formula Injection Mitigation, exportMaxRows Enforcement Over chunk(), kore_toast(), IDOR Protection via Query Scoping, LIKE Wildcard Literal Escaping (+13 more)
...
Cohesion: 0.12
Nodes (17): [1.4.0] — 2026-07-13, Added, Added, Added, Added, Added, Added, Added (+9 more)
...
Cohesion: 0.12
Nodes (16): [1.3.0] — 2026-06-04, Added, Added, Added, Added, Added, Added, Added (+8 more)
...
Cohesion: 0.13
Nodes (4): TestEditableTable, TestQueryStringTable, TestTable, KoreDataTable Alpine Component
...
Cohesion: 0.16
Nodes (15): BadgeColumn, ColorColumn, ColorColumnSecurityTest, ColumnInteractionTest, ColumnTypesTest, ComponentColumn, DateColumn, ExportTest (+7 more)
...
Cohesion: 0.15
Nodes (13): ActionColumn, BadgeColumn, ComponentColumn, DateColumn, ImageColumn, LinkColumn, ProgressColumn, RowAction class (+5 more)
...
Cohesion: 0.38
Nodes (11): [1.4.1] — 2026-07-13, code:js (if (!target) target = objects[objects.length - 1];   // el x), code:css ([wire\:loading], [wire\:loading\.delay], [wire\:loading\.fle), code:diff (- <div wire:loading.delay.flex class="absolute inset-0 …">), Fixed, Fixed, Fixed, Fixed (+3 more)
...
Cohesion: 0.2
Nodes (9): [1.0.0] — 2026-04-03, Changelog, Fixed, Fixed, Fixed, Fixed, Fixed, Fixed (+1 more)
...
Cohesion: 0.25
Nodes (8): [1.1.0] — 2026-04-04, Added, Added, Added, Added, Added, Added, Added
...
Cohesion: 0.83
Nodes (4): FilterPreset, FilterPresetsTest, TestDefaultPresetTable, TestPresetsTable
...
## Knowledge Gaps
- **1251 isolated node(s):** `medias`, `panels`, `gutterEls`, `startSizes`, `instances` (+1246 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `DataTable Test Fixtures` to `circle.blade.php`, `index.blade.php`, `item.blade.php`, `CustomOverlay`, `KoreDataTable Query Engine`, `field.blade.php`, `manager.blade.php`, `slide-down.blade.php`, `BreadcrumbManager Class`, `multi-select.blade.php`, `checkbox.blade.php`?**
