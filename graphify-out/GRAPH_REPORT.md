...
## Corpus Check
- 498 files · ~172,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4149 nodes · 4563 edges · 593 communities (428 shown, 165 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 265 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6549140`
...
## Communities (593 total, 165 thin omitted)
...
Cohesion: 0.16
Nodes (20): BulkActionExecuted, ColumnPinningTest, CsvExporter, Base Filtered Query Pattern, EventsTest, Exporter (interface), FilterApplied, KoreDataTable (+12 more)

### Community 40 - "SpotlightDefaults"
Cohesion: 0.11
Nodes (5): TestEditableTable, TestExportTable, TestScopedEditableTable, TestTable, KoreDataTable Alpine Component
...
Cohesion: 0.29
Nodes (18): [0.1.0] — 2026-03-18, Added, Added, Added, Added, Added, Componentes de Formulario (18), Componentes UI (20+) (+10 more)
...
Cohesion: 0.12
Nodes (17): [1.2.0] — 2026-06-03, Accessibility, Added, Added, Added, Added, Changed, Changed (+9 more)
...
Cohesion: 0.14
Nodes (5): columns(), query(), TestBulkTable, TestSearchTable, TestUser
...
Cohesion: 0.12
Nodes (15): Cómo funciona (y por qué importa), code:blade (<x-kore::chart :data="$ventas" x="mes" title="Ingresos y gas), code:php ($ventas = [), code:blade (<x-kore::chart.line y="errores" color="destructive" />), code:blade (<body>), code:css (@import 'tailwindcss';), code:php ('chart' => [), Configuración (+7 more)
...
Cohesion: 0.13
Nodes (15): [1.5.0] — 2026-07-13, Added, Added, Added, Changed, Changed, Changed, Detalles que quizá quieras conocer (+7 more)
...
Cohesion: 0.17
Nodes (3): Chart, renderColorColumn(), FeedbackManager
...
Cohesion: 0.17
Nodes (11): [1.0.0] — 2026-04-03, [1.1.0] — 2026-04-04, Added, Added, Added, Added, Changelog, Fixed (+3 more)
...
Cohesion: 0.18
Nodes (11): [1.4.0] — 2026-07-13, Added, Added, Added, Added, Chore, Deprecated, Fixed (+3 more)
...
Cohesion: 0.22
Nodes (9): Confirm-callback forgery-resistant authorization, Confirm, ConfirmCallbackSecurityTest test suite, ConfirmTest test suite, DemoComponent fixture class, DemoComponent::handleConfirm, DemoComponent::secretAction (protected), DemoComponent::sendConfirm (+1 more)
...
Cohesion: 0.2
Nodes (10): [1.3.0] — 2026-06-04, Added, Added, Added, Added, Fixed, Fixed, Fixed (+2 more)
...
Cohesion: 0.27
Nodes (9): DemoComponent::sendToast, FeedbackDefaults, FeedbackManager, kore_toast(), Kore (Facade), KoreManager, KoreUiServiceProvider, Toast (+1 more)
...
Cohesion: 0.4
Nodes (5): [1.6.0] — 2026-07-14, Added, Changed, Detalles que quizá quieras conocer, El principio que ordena todo el módulo
...
### Community 307 - "SpeedDialTest.php"
Cohesion: 0.67
...
## Knowledge Gaps
- **1206 isolated node(s):** `medias`, `panels`, `gutterEls`, `startSizes`, `instances` (+1201 more)
...
- **What is the exact relationship between `kore_toast()` and `TestBulkTable`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Column Class (DataTable domain model)` connect `Time Picker (JS)` to `circle.blade.php`, `tree.js`, `item.blade.php`, `index.blade.php`, `Kore Avatar Component`, `SpotlightDefaults`, `HasOverlayBehavior.php`, `DataTable Core Model`, `Alpine Plugin Registry`, `multi-select.blade.php`?**
