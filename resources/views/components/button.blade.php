...
@php
    ...
    $colorClasses = match($variant) {
        ...
        'outline' => match($color) {
            'primary' => 'border border-kore-primary text-kore-primary hover:bg-kore-primary/10',
            'secondary' => 'border border-kore-border text-kore-fg hover:bg-kore-muted',
            'destructive' => 'border border-kore-destructive text-kore-destructive hover:bg-kore-destructive/10',
            'success' => 'border border-kore-success text-kore-success hover:bg-kore-success/10',
            'warning' => 'border border-kore-warning text-kore-warning hover:bg-kore-warning/10',
            'info' => 'border border-kore-info text-kore-info hover:bg-kore-info/10',
            default => 'border border-kore-primary text-kore-primary hover:bg-kore-primary/10',
        },
        'ghost' => match($color) {
        ...
        'soft' => match($color) {
            'primary' => 'bg-kore-primary/10 text-kore-primary hover:bg-kore-primary/20',
            'secondary' => 'bg-kore-secondary text-kore-secondary-fg hover:bg-kore-secondary/80',
            'destructive' => 'bg-kore-destructive/10 text-kore-destructive hover:bg-kore-destructive/20',
            'success' => 'bg-kore-success/10 text-kore-success hover:bg-kore-success/20',
            'warning' => 'bg-kore-warning/10 text-kore-warning hover:bg-kore-warning/20',
            'info' => 'bg-kore-info/10 text-kore-info hover:bg-kore-info/20',
            default => 'bg-kore-primary/10 text-kore-primary hover:bg-kore-primary/20',
        },
        'link' => match($color) {
            'primary' => 'text-kore-primary underline-offset-4 hover:underline',
            'secondary' => 'text-kore-fg underline-offset-4 hover:underline',
            'destructive' => 'text-kore-destructive underline-offset-4 hover:underline',
            default => 'text-kore-primary underline-offset-4 hover:underline',
        },
        default => 'bg-kore-primary text-kore-primary-fg hover:bg-kore-primary/90',
    };
